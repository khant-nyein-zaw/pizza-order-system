    ...
    <div class="container-fluid bg-dark mb-30">
        <div class="row px-md-5 align-items-center">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="{{ route('user#home') }}" class="text-decoration-none d-block my-3">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">Pizza</span>
                    <span class="h1 text-uppercase text-dark bg-primary px-2">Maru</span>
                </a>
            </div>
            <div class="col-lg-9">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown-center">
                        <button type="button" class="btn btn-warning dropdown-toggle rounded rounded-pill"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fa-solid fa-address-card pe-1"></i> {{ Auth::user()->name }}
                        </button>
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <li>
                                <a class="dropdown-item" href="{{ route('user#editPage') }}">
                                    <i class="fa-solid fa-user me-2"></i> Profile
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('user#passwordChangePage') }}">
