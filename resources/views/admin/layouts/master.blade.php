                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="has-sub">
                            <a class="js-arrow" href="{{ route('category#list') }}">
                                <i class="fa-solid fa-rectangle-list"></i> Category
                            </a>
                        </li>
                        <li class="has-sub">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="{{ route('users#contact') }}">
                                <i class="fa-solid fa-envelope"></i> User Feedbacks
                            </a>
                        </li>
                    </ul>
                </nav>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <h3 class="text-primary text-uppercase">
                                Admin Dashboard Panel <i class="fa fa-dashboard"></i>
                            </h3>
                                                        ...
                                                        @else
                                                            @if (Auth::user()->gender == 'male')
                                                                <img src="{{ asset('image/user.png') }}"
                                                                    class="img-fluid">
                                                            @else
                                                                <img src="{{ asset('image/user (2).png') }}"
                                                                    class="img-fluid">
                                                            @endif
                                                        @endif
                                                    </a>
